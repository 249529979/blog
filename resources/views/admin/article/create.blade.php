            ...
            <form action="{{url('admin/article')}}" method="post">
                ...
                <table class="add_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="editor" name="content" type="text/plain" style="width:860px;height:400px;"></textarea>
            ...
            $(function() {
                ...
                $('#file_upload').uploadifive({
                    ...
                    'onUploadComplete'  : function (file, data, response) {
                        var img = '<img src="' + data + '" id="art_thumb_img" style="margin-top: 10px; max-width: 350px; max-height: 100px;"/>'
