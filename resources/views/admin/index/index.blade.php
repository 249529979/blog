@extends('layouts.admin')
    @section('content')
        ...
        <div class="menu_box">
            <ul>
                <li>
                    ...
                    <ul class="sub_menu">
                        <li><a href="{{url('admin/category/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>新增分类</a></li>
                ...
                <li>
                    ...
                    <ul class="sub_menu">
                        <li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-bookmark"></i>友情链接</a></li>
                        <li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-navicon"></i>菜单列表</a></li>
                ...
                {{--<li>--}}
                    ...
                    {{--<ul class="sub_menu">--}}
                        ...
                        {{--</li>--}}
                        {{--<li><a href="http://tool.c7sky.com/webcolor/" target="main"><i--}}
                                        {{--class="fa fa-fw fa-tachometer"></i>配色板</a></li>--}}
        ...
        <div class="bottom_box">
            CopyRight © 2016. Powered By <a href="http://www.lnmp.org.cn">http://www.lnmp.org.cn</a>.
        </div>
        <!--底部 结束-->
    @endsection